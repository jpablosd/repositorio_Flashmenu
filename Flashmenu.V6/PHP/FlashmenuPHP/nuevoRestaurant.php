...
if (isset($_POST['Rest_nombre']) && isset($_POST['Rest_tipo']) && isset($_POST['Rest_email'])) {
    ...
    $result = mysql_query("INSERT INTO restaurant(Rest_nombre, Rest_tipo, Rest_descripcion, Rest_caracteristicas, Rest_email, Rest_direccion, Administrador_restaurant_idAdministrador_restaurant) VALUES('$nomRest' ,'$tipoRest' ,'$descripRest', '$caractRest', '$emailRest', '$direccionRest', 1)");
