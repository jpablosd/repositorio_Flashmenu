...
public class cantPersonasHorario  extends Activity {
	...
	Button btnHaciaMenu, btnHaciaCalendario;
	String L;
	...
	protected void onCreate(Bundle savedInstanceState) {
	  ...
	  // setContentView(R.layout.cantpersonarcalendario);
	  ...
	  /* btnHaciaCalendario = (Button) findViewById(R.id.haciaCalendario);
	   btnHaciaCalendario.setOnClickListener(new View.OnClickListener() {
	   ...
	   */
	   btnHaciaMenu = (Button) findViewById(R.id.haciaCalendario);
