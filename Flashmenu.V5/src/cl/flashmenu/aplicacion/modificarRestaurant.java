...
public class modificarRestaurant extends Activity {
    ...
    private static String url_detalles_rest = "http://200.83.21.43/PHP/FlashmenuPHP/datosRestaurant.php";
 	
	
	//private static final String url_actualizar_rest = "http://190.153.212.77/daniel_fernandez/actualizarRestaurant.php";
	private static final String url_actualizar_rest = "http://200.83.21.43/PHP/FlashmenuPHP/actualizarRestaurant.php";
