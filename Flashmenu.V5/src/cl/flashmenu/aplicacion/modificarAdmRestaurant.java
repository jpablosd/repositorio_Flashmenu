...
public class modificarAdmRestaurant extends Activity {
	...
	private static String url_detalles_adm = "http://200.83.21.43/PHP/FlashmenuPHP/datosAdmRestaurant.php";
	
	
   //  private static final String url_actualizar_adm = "http://190.153.212.77/daniel_fernandez/actualizarAdmRestaurant.php";
   private static String url_actualizar_adm = "http://200.83.21.43/PHP/FlashmenuPHP/actualizarAdmRestaurant.php";
	 
   //  private static final String url_borrar_adm = "http://190.153.212.77/daniel_fernandez/borrarAdmRestaurant.php";
     private static String url_borrar_adm = "http://200.83.21.43/PHP/FlashmenuPHP/borrarAdmRestaurant.php";
	...
	class Delete extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			try {
				// Building Parameters
				List<NameValuePair> params = new ArrayList<NameValuePair>();
				params.add(new BasicNameValuePair("cedula", mail));

				// getting details by making HTTP request
				JSONObject json = jsonParser.makeHttpRequest(
						url_borrar_adm, "POST", params);
